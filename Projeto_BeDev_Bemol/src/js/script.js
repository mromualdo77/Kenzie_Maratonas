...
const inputTempo = document.querySelector(".inputSliderTempo")
...
const buutton = document.getElementsByClassName("simulatorButton")[0]
...
buutton.addEventListener("click", calcularPontos)