b//SELECIONANDO A LISTA PARA ADICIONAR OS PRODUTOS
...
//ADICIONANDO INTECEPTADOR NA LISTA DE PRODUTOS
...
const listarProdutosCarrinho = document.querySelector(".listaProdutos")
listarProdutosCarrinho.addEventListener("click", removerProdutoCarrinho)
...
function removerProdutoCarrinho(event){
     ...
     if(botaoExcluir.tagName == "BUTTON"){
        ...
        botaoExcluir.closest("li").remover()
